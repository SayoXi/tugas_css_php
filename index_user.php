  ...
  <?php 
    ...
    <nav class="navbar navbar-expand-lg " style="background-color: lightblue !important; ">
        <div class="container">
            ...
            <div> <a href="pesanan.php "class="btn btn-info " style="font-family: Poppins; font-size: 15px;"><i class="fa fa-shopping-cart"></i> Daftar Pesanan </a>
           <a href="logout.php "class="btn btn-danger " style="font-family: Poppins; font-size: 15px;"> Logout <i class="fa fa-arrow-circle-right"></i></a>
          </div>
