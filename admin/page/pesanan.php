...
<head>
    ...
    <title>ADMIN - HALAMAN DATA PESANAN</title>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table" id="myTable">
                                        ...
                                        <tbody>
                                        <?php //Perulangan untuk tabel pesanan
                    while($hasil = mysqli_fetch_object($ambilData)) { if ($hasil->status == 1) { ?>
                        <tr>
                            ...
                            <td class="text"><span class="btn btn-danger">Belum Dikonfirmasi</span></td>
                            <td class="text"><a href="pesanan.php?id=<?= $hasil->id_pesanan ?>" class="btn btn-warning">Konfirmasi</a></td>
                        </tr>   
